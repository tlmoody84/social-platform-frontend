...
const Home: React.FC = () => {
  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold text-center mb-6 text-purple-600">All Posts</h1>
      {posts.map((post) => (
        <div key={post.id} className="mb-4 p-4 border rounded-lg shadow-md bg-white">
          <h2 className="text-xl font-semibold text-pink-600">{post.content}</h2>
          <p className="text-gray-600">Likes: {post.likes}</p>
          
          <h3 className="mt-2 text-lg font-semibold text-green-600">Comments:</h3>
